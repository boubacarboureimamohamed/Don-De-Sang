                    ...
                    <div class="col-sm-6">
                         <div class="form-group form-primary">
                            <div class="input-group">
                                ...
                                <input type="text" title="Entrer le numéro de téléphone du donneur" value="{{ old('telephone') }}" data-toggle="tooltip-effect-9 tooltip-content-3" id="telephone" name="telephone" class="form-control phone" data-mask="9999-99-99-99-99"  placeholder="Téléphone">
                            </div>
                         </div>
                     </div>
                </div>
